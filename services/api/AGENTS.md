...
- Nearby estimate freshness is supported by both retained member streams and uses the older of their newest sample instants. One uploading member cannot make the two-person result appear current.
