...
/** Pure formatting and stale-state tests shared by all Wear surfaces. */
public final class WearDisplayCacheTest {
    ...
    public void rendersRelationshipAndNearbyAsSeparateValues() {
        ...
        assertEquals("42 days", state.relationshipText(today));
        assertEquals("2h 30m nearby", state.nearbyText());
